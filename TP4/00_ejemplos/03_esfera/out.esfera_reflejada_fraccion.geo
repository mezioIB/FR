...
r = 33.7;                     // Radio de la esfera
b = 30;          // Espesor del reflector
fracEsf1 = 64;           //Fracción de la esfera en un ángulo
fracEsf2 = 4;                      //Fracción de la esfera en la otra dirección angular
lcB = 2; // Longitud caracteristica del elemento cerca del borde
lcI = 0.5; // Longitud caracteristica del elemento cerca de la interface
lcC = 1; // Longitud caracteristica del elemento cerca del centro
